...
{
    public class ItemFurance : BuildingSystem, IInventoryItem
    {
        private const string TAG_BUILD_OBJECT = "furance";
        ...
        public ItemFurance(IInventoryItemInfo info)
        {
            this.info = info;
        ...
        {
            var clone = new ItemFurance(info);
