...
namespace TheIslandKOD
{
    ...
    public class ItemCampFire : BuildingSystem, IInventoryItem
    {
        private const string TAG_BUILD_OBJECT = "campFire";
        ...
        public ItemCampFire(IInventoryItemInfo info)
        {
            this.info = info;
        ...
        {
            var clone = new ItemCampFire(info);
